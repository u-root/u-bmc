...
include $(ROOT_DIR)apparmor/Makefile.inc
...
initramfs.cpio: u-bmc ssh_keys.pub $(shell find $(ROOT_DIR)apparmor $(ROOT_DIR)cmd $(ROOT_DIR)pkg $(ROOT_DIR)proto -name \*.go -type f)
	go generate ./config/
