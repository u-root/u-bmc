...
import (
	...
	"github.com/u-root/u-bmc/pkg/hardware"
	"github.com/u-root/u-bmc/pkg/hardware/fan"
	"github.com/u-root/u-bmc/pkg/hardware/gpio"
	"github.com/u-root/u-bmc/pkg/hardware/uart"
	"github.com/u-root/u-bmc/pkg/network/iface"
	"github.com/u-root/u-bmc/pkg/network/sshd"
	"github.com/u-root/u-bmc/pkg/network/ttime"
	"github.com/u-root/u-bmc/pkg/network/web"
	"github.com/u-root/u-bmc/pkg/service/grpc"
	uproto "github.com/u-root/u-bmc/pkg/service/grpc/proto"
...
func seedRandomGenerator() {
	...
	var seed int64
	if err := binary.Read(buf, hardware.NativeEndian(), &seed); err != nil {
...
func StartupWithConfig(plat Platform, conf *config.Config) (error, chan error) {
	...
	uart, err := uart.StartUart(tty, baud)
	if err != nil {
	...
	_, err = iface.StartNetwork(sysconf.Network)
	if err != nil {
